    ...
    class Program
    {
        ...
        mainMenu:
            ...
            */
            ...
            Console.WriteLine(jatekosStatja[1]);
            Console.WriteLine(jatekosStatja[0]);
            Console.WriteLine(jatekosKardSebzes[0]);
            Console.WriteLine(jatekosKardSebzes[1]);
            Console.WriteLine(jatekosPancelEletero[0]);
        ...
        fojatek:
            ...
            Console.WriteLine("---------------------------------------------------------");
            Console.WriteLine();
            Console.WriteLine(CsataJatekosEleteroStatja);
            Console.ReadLine();
            ...
            else //minden wave ami nem MiniBoss vagy FinalBoss
            {
                Console.Clear();
                Console.WriteLine("----------------------------------------------------------");
                Console.WriteLine("Simma goblinukal hardcolsz");
                Console.WriteLine("----------------------------------------------------------");
                Boolean jatekKimenet = false;
                while (CsataJatekosEleteroStatja!=0||CsataMobEletero!=0){
